...
export class OutputFormatter {
     ...
     */
    applyPrettyFormattingToColoredLines(lines) {
        const result = [];
        let lastTopLevel = '';
        lines.forEach((line, index) => {
